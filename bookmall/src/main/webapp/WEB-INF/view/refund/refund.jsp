	...
	<%@ include file="/WEB-INF/view/include/header.jsp"%>
		<div class="sub">
			<div class="sub_visual">
				<div class="slogan">주문 취소/환불 신청</div>
			</div>
			<div class="size">
				<div class="box">
						...
						<table class="type">
							<thead>
								<tr>
									<th>
										<input type="radio" id="cancle" name="pick" value="7" checked ><label for ='cancle'>취소</label>
									</th>
									<th>
										<input type="radio" id="refund" name="pick" value="13"><label for ='refund'>환불</label>
									</th>
									${refundData.pick }
						...
						<div class="text"></div>
						<table class="type"><br>
						| 사유 및 기타 메세지 입력<font size="2px;">*파본, 상품불량이나 취소/환불 사유에 대해 기입해주세요.</font><br>
								<tr>
