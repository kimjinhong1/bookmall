...
<body>
    <div class="wrap">
        ...
        <div class="sub">
            <div class="size">
                <h3 class="sub_title">1:1문의게시판</h3>
                <div class="bbs">
                    <div class="view">
                        <div class="title">
                            <dl>
                        ...
                        <div class="cont"><p>${ask.content }</p> </div>
                        <dl class="file">
                            <dt>첨부파일 </dt>
                            <dd>
                            <a href="/bookmall/common/download.jsp?path=/upload/&org=${ask.filename_org}&real=${ask.filename_real}" 
                            target="_blank">${ask.filename_org } </a></dd>
                        </dl>
                    ...
                    <form method="post" name="frm" id="frm" action="" enctype="multipart/form-data" >
                    	<input type="hidden" name="tablename" value="askboard">
