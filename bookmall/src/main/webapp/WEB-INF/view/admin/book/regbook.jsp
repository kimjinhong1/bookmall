				...
				<div class="con">
					...
					<tbody>
						<tr>
                            ...
                            <td>
                                <input type="text" name="isbn" id="isbn" class="inNextBtn" style="float:left;" maxlength="13" placeholder="ISBN번호를 13자리 입력해주세요.(숫자만)">
                            </td>
						</tr>
						<tr>
                            <th><small class="star">*</small> 도서명 </th>
                            <td>
                            	<input type="text" name="btitle_first" id="btitle_first" style="float:left;" maxlength="50" placeholder="대제목을 입력해주세요"> 
                            	<input type="text" name="btitle_second" id="btitle_second" style="float:left;" maxlength="50" placeholder="소제목을 입력해주세요">
                            </td>
                        </tr>
                        <tr>
                            <th><small class="star">*</small> 저자 </th>
                            <td>
                            	<input type="text" name="author" id="author" style="float:left;" maxlength="20" placeholder="저자를 입력해주세요"> 
                            </td>
                        </tr>
                        <tr>
                            <th><small class="star">*</small> 출판사 </th>
                            <td>
                            	<input type="text" name="publisher" id="publisher" style="float:left;" maxlength="20" placeholder="출판사를 입력해주세요"> 
                            </td>
                        </tr>
                        <tr>
                            <th><small class="star">*</small> 출간일 </th>
                            <td>
                            	<input type="text" name="pubdate" id="pubdate" style="float:left;" maxlength="20" placeholder="출간일을 선택해주세요."> 
                            </td>
                        </tr>
                        <tr>
                            <th><small class="star">*</small> 가격 </th>
                            <td>
                            	<input type="text" name="price" id="price" style="float:left;" maxlength="20" placeholder="가격을 입력해주세요."> 
                            </td>
                        </tr>
                        <tr>
                            <th><small class="star">*</small> 할인율 </th>
                            <td>
                            	<input type="number" name="discountrate" id="discountrate" style="float:left;" min="0" max="100" maxlength="15" placeholder="할인율을 입력해주세요.">
                        ...
                        <tr>
                            ...
                            <td>
                            	<input type="text" name="salesprice" id="salesprice" style="float:left;" maxlength="20" readonly>원 
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                            	<div>&nbsp;
                            	<input type="radio" name="classify" id="classify0" value="0" checked="checked">&nbsp;
                        ...
                        <tr class="hide" id="hide"> <!-- 처음에 숨김 -->
                            ...
                            <td>
                                <input type="text" name="translator" id="translator" class="inNextBtn" style="float:left;" placeholder="번역한 이를 입력해주세요.">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                            	<input type="text" name="bpages" id="bpages" style="float:left;" maxlength="20" placeholder="페이지를 입력해주세요.">(쪽) 
                            </td>
                        </tr>
                        <tr>
                            <th><small class="star">*</small> 무게 </th>
                            <td>
                            	<input type="text" name="bweight" id="bweight" style="float:left;" maxlength="20" placeholder="무게를 입력해주세요.">(g) 
                            </td>
                        </tr>
                        <tr>
                            <th><small class="star">*</small> 크기 </th>
                            <td>
                            	<input type="text" name="bwidth" id="bwidth" style="float:left;" maxlength="5" placeholder="가로">
                        ...
                        <tr>
                            ...
                            <td>
                            	<input type="text" name="bstack" id="bstack" style="float:left;" maxlength="20" placeholder="재고를 입력해주세요."> 
                            </td>
                        </tr>
                        <tr>
							<th scope="row"><label for="">*내용</label></th>
							<td colspan="30">
								<textarea id="bintroduce" name="bintroduce" title="내용을 입력해주세요" rows="10" cols="100"></textarea>	
							</td>
						</tr>
						<tr>
							<th scope="row"><label for="">*내용</label></th>
							<td colspan="30">
								<textarea id="bindex" name="bindex" title="내용을 입력해주세요" rows="10" cols="100"></textarea>	
							</td>
						</tr>
						<tr>
