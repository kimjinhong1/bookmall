...
$(function() {
	nhn.husky.EZCreator.createInIFrame({
		oAppRef: oEditors,
		elPlaceHolder: "answer",	// textarea ID
		sSkinURI: "<%=request.getContextPath()%>/smarteditor/SmartEditor2Skin.html",	
		htParams : {
			bUseToolbar : true,				// 툴바 사용 여부 (true:사용/ false:사용하지 않음)
			bUseVerticalResizer : true,		// 입력창 크기 조절바 사용 여부 (true:사용/ false:사용하지 않음)
				...
				<div class="con">
					...
					<div id="bbs">
						<div id="bread">
			                ...
			                <input type="hidden" name="ono" value="${askdata.ono}">
							<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="관리자 관리 기본내용입니다.">
								...
								<tbody>
									...
									<tr>
										...
										<td colspan="10">
											<input type="text" id="title" name="title" class="w100" title="제목을 입력해주세요" value="${askdata.title}"/>	
										</td>
									</tr>
									<tr>
										<th scope="row"><label for="">*내용</label></th>
										<td colspan="6">
											<textarea id="contents" name="content" title="내용을 입력해주세요" style="width:100%;">${askdata.content} <br> </textarea>	
										</td>
									</tr>
								 <tr>
									<th scope="row"><label for="">*답변</label></th>
										<td colspan="6">
		                                <textarea id="answer" name="answer" title="답변을 입력해주세요" style="width:100%;">${askdata.answer}</textarea>	
		                            </td>
		                        </tr>
									<tr>
