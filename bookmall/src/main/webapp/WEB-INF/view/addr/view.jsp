...
<body>
    <div class="wrap">
                ...
                <input type="hidden" name="addno" value="${addBook.addno }">
                <table class="board_write">
                    ...
                    <tbody>
                            ...
                            <td><input type="text" name="division" id="division" value="${addBook.division }"style="float:left;" maxlength="20">&nbsp;&nbsp;
                            <span class="division_check"></span>
                             </td>
                        </tr>
                        <tr>
                            <th><small class="star">*</small> 수령인</th>
                            <td><input type="text" name="name" id="name" value="${addBook.name }"style="float:left;" maxlength="20"> </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <small>&nbsp;-&nbsp;</small>
                                <input type="text" name="tel2" id="tel2" value="${addBook.tel2 }"  maxlength="4" style="width:60px;">
                                <small>&nbsp;-&nbsp;</small>
                                <input type="text" name="tel3" id="tel3" value="${addBook.tel3 }"   maxlength="4" style="width:60px;">
                            </td>
                        </tr>
                        <tr>
                ...
                <div class="btnSet clear">
                    <div><a href="javascript:goSave();" class="btns">수정</a> &nbsp;&nbsp;&nbsp;
