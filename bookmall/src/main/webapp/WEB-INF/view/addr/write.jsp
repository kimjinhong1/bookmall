            ...
            <div class="size">
                ...
                <table class="board_write">
                    ...
                    <tbody>
                        ...
                        <tr>                        	
                        	<td>
                        		<input type="text" name="address" id="address"  style="float:left;width:500px">
                        	</td>
                        </tr>
                        <tr>                        	
                        	<td>
                        		<input type="text" name="address2" id="address2"  style="float:left;width:500px">
                        	</td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div class="btnSet clear">
                    ...
                    <a href="javascript:;" class="btns" onclick="history.back();">취소</a></div>
                </div>
            </div>
        </div>
