...
<script>
	...
	$("ul.tabs li").click(function () { 
		...
		$(".tab_content").hide() var activeTab = $(this).attr("rel"); 
		$("#" + activeTab).fadeIn() }); });
		...
		<div class="sub">
				...
				<div class="box">
					...
					<div class="under">
						...
						<table class="type">
							<thead>
								<tr>
									<th><input type="radio" id="broken" name="refund1"
										value="1">상품파손</th>
									<th><input type="radio" id="wrong" name="refund1"
										value="2">오배송</th>
									<th><input type="radio" id="change" name="refund1"
										value="3">변심</th>
									<th><input type="radio" id="delay" name="refund1"
										value="4">배송지연</th>
									<th><input type="radio" id="defect" name="refund1"
										value="5">제작불량</th>
								</tr>
								<tr>
							</thead>
			...
			<div class="size">
				<div class="box">
					...
					<div class="under">
						<div class="text"></div>
						| 반품사유 및 기타 메세지 입력<font size="2px;">*파본, 상품불량이나 반품 사유에 대해 기입해주세요.</font>
						<table class="type">
							<thead>
							<tbody>
								<th></th>
